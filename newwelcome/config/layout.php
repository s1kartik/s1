...
/* Tilegroup settings */
//$groupTitles = array('About Us','For Workers','For Employers', 'For Unions', 'Our Tools'); Removed "our tools" on Sep-09-2015
$groupTitles = array('About Us','For Workers','For Employers', 'For Unions');// titles of the tileGroups
//$groupSpacing = array(4,4,4,4); // removed 4th item '4' after remover 'our tools' menu on Sep-09-2015
...
$bgImage = "img/welcome/bg/metro_s1.jpg"; // background image, leave blank if you dont want one. It is recommend to keep the filesize to a minimum and also, if possible, use a low resolution
