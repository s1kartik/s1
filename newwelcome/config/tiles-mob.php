...
$tile[] = array("type"=>"slideshow","group"=>0,"x"=>0,"y"=>1,"width"=>1,"height"=>1,"background"=>"#6950ab","url"=>"",
	...
	"classes"=>"noClick");	
$tile[] = array("type"=>"scrollText","group"=>0,"x"=>0,"y"=>2,"width"=>2,"height"=>1,"background"=>"#e61e25","url"=>"external:panels/login.php",
"title"=>"<strong style='font-size:45px;'>JOIN NOW</strong><br> TO CHANGE THE WAY YOU DO SAFETY");

$tile[] = array("type"=>"custom","group"=>0,"x"=>1,"y"=>1,'width'=>1,'height'=>1,"background"=>"#e61e25","url"=>"for-workers.php",
"content"=>
...
$tile[] = array("type"=>"slideshow","group"=>1,"x"=>0,"y"=>2,"width"=>1,"height"=>1,"background"=>"#ed1c24","url"=>"workers-toolbox.php",
...
$tile[] = array("type"=>"flip","group"=>1,"x"=>1,"y"=>2,'width'=>1,'height'=>1,"background"=>"#333333","url"=>"external:panels/login.php","img"=>"img/welcome/workers/metro_150x150.png",
...
$tile[] = array("type"=>"slideshow","group"=>2,"x"=>0,"y"=>2,"width"=>1,"height"=>1,"background"=>"#FF8000","url"=>"employers-toolbox.php",
...
$tile[] = array("type"=>"flip","group"=>2,"x"=>1,"y"=>2,'width'=>1,'height'=>1,"background"=>"#333333","url"=>"external:panels/login.php","img"=>"img/welcome/employers/metro_150x150.png",
	"text"=>"<h4 style='color:#FFF;font-size:22px'><b>FREE</b></h4><h4 style='color:#FFF;font-size:22px'><b>TO</b></h4><h4 style='color:#FFF;font-size:22px'><b>JOIN!</b></h4>");
...
$tile[] = array("type"=>"scrollText","group"=>3,"x"=>0,"y"=>2,"width"=>2,"height"=>1,"background"=>"#e61e25","url"=>"external:img/welcome/union/union.png",
...
$tile[] = array("type"=>"custom","group"=>3,"x"=>1,"y"=>1,'width'=>1,'height'=>1,"background"=>"#e61e25","url"=>"external:panels/login.php",
"content"=>
