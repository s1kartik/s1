...
array("type"=>"img","group"=>0,"x"=>1,"y"=>0,'width'=>1,'height'=>1,"background"=>"#0F6D32","url"=>"",
	"img"=>"img/welcome/img3.jpg","desc"=>"By adding the CSS class 'noClock' to this tile, we've achieved that there is no hover effect!",
...
$sidebar["some_info"] = array("pos"=>"left","size"=>2,"full_height"=>true/*<- this sets wether the sidebar should be the full page height or not*/,
	...
	"tiles"=>array( /* Open the array of sidebar tiles */
		...
		array("type"=>"flip","group"=>0,"x"=>1,"y"=>0,'width'=>1,'height'=>1,"background"=>"#C82345","url"=>"","img"=>"img/welcome/metro_150x150.png",
	...
	"text"=>"<h3>Check the accordions</h3>","img"=>"img/welcome/metro_slide_300x150_2.png","imgSize"=>1,
	"slidePercent"=>0.40,
