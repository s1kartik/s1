...
<div class="homebg metro profile-view">
    ...
    <div class="container">
        ...
        <em class="margin20">ABOUT ME - GENERAL</em>
        </div>
    </div>
    <!--END PAGE TITLE-->
    <div class="container">
        ...
        <div class="tile-group two no-margin no-padding actual-size-logos " >
                    ...
                    <div class="email-image">
						<?php 
						 if( isset($rows_my_messages[0]['profile_image']) && $rows_my_messages[0]['profile_image'] && file_exists(FCPATH.$this->path_upload_profiles.$rows_my_messages[0]['profile_image']) ) {?>
							<img width="200" height="180" src="<?php echo $base.$this->path_upload_profiles.$user['profile_image'];?>"/>
							<?php 
						}
						else {?><img width="200" height="180" src="<?php echo $base;?>img/default.png" /><?php }?>
					</div>
        ...
        <div class="tile-group three no-margin no-padding" >
			...
			<a class="tile bg-black" href="<?php echo $base."admin/fatality_metro";?>">
				...
				<div class="brand"><div class="label">Fatality Breakdown</div></div>
			</a>
