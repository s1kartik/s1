...
<?php endif;?>
        <form class="form-horizontal adminfrm"  name="frm_worker_personal_info" id="frm_worker_personal_info" method="post" enctype="multipart/form-data" action="<?php echo $base;?>admin/profile_setting?section=personal">
               <!-- Text input-->
