...
<div class="homebg metro profile-view">
    ...
    <div class="container">
        ...
        <em class="margin20">PROFILE SETTINGS&nbsp;&nbsp;
        	<a href="#info_profile_settings_employer_modal" data-toggle='modal'><span class="icon-info-2 s1_info fg-white"></span></a>
        </em> 
        </div>
    </div>
    <!-- Start INFO Modal --> 
    <?php // Modal: INFO//
	$this->load->view('info/profile_settings_employer_modal');?>	
    <!-- End INFO Modal -->
    <!--END PAGE TITLE-->
    <div class="container">
