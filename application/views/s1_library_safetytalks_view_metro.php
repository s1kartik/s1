...
?>
<a href="#modal_shopping_items<?php echo $item_id;?>" rel="#" <?php echo $cart_href_string;?> class="tile half-library bg-black <?php echo $class_addtocart;?> description" style="opacity:0.8;" data-toggle="modal" data-content="<?php echo $new_contents_on_hover;?>" data-original-title="<?php echo "<h6 class='margin10'>".$ct_title."</h6>";?>" data-placement="bottom" data-trigger="hover">
	<img src="<?php echo $base.$this->path_img_library."add55.png";?>" />
	<span class='margin5 fg-white' style="position:absolute;top:0px;"><b><small><?php echo $ct_title;?></small></b></span>
</a>
