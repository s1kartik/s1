        ...
        <fieldset>
            ...
            <legend>New Page in <?php echo $library['title'];?></legend>
						...
						<div class="imageblock-sample" id="id_div_image_pr1">
							...
							<div class="control-group" id="id_div_image_pr1img1">
							  ...
							  <?php 
								if( $show_desc ) {?>
								  <div class="controls">
									<textarea id="description_pr1imgdesc1" name="description_img[pr1][new][]" placeholder="Image Description" class="content-editor"></textarea>
				...
				<div class="mart10">
					...
					<input type="hidden" name="pn" value="<?php echo $pn+1;?>" />
