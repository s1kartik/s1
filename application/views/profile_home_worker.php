...
<script type="text/javascript">
    ...
    <div class="container-fluid">
        ...
        <em class="margin20">HOME - WORKER
        	<a href="#info_profile_home_worker_modal" data-toggle='modal'><span class="icon-info-2 s1_info fg-white"></span></a>
            </em>
        </div>
    </div>
    <!-- Start INFO Modal --> 
    <?php // Modal: INFO//
					$this->load->view('info/profile_home_worker_modal');
...
<div id="myCarousel" class="carousel slide">
    ...
    <div class="carousel-inner">
	    <div class="active item">
	       	<img src="<?php echo $base;?>img/profile-slider/worker/banner-0.jpg" />
	    </div>
	
	    <div class="item">
	       		<img src="<?php echo $base;?>img/profile-slider/worker/banner-1.jpg" />
	    </div>
	    
		<div class="item">
	    	<img src="<?php echo $base;?>img/profile-slider/worker/banner-2.jpg" />
	    </div>
	    
	    <div class="item">
	    	<img src="<?php echo $base;?>img/profile-slider/worker/banner-3.jpg" />
	    </div>
	    <div class="item">
	    	<img src="<?php echo $base;?>img/profile-slider/worker/banner-4.jpg" />
	    </div>
	    <div class="item">
	    	<img src="<?php echo $base;?>img/profile-slider/worker/banner-5.jpg" />
	    </div>
	    <div class="item">
	    	<img src="<?php echo $base;?>img/profile-slider/worker/banner-6.jpg" />
	    </div>
	    <div class="item">
	    	<img src="<?php echo $base;?>img/profile-slider/worker/banner-7.jpg" />
	    </div>
	    <div class="item">
	    	<img src="<?php echo $base;?>img/profile-slider/worker/banner-8.jpg" />
	    </div>
	    <div class="item">
	    	<img src="<?php echo $base;?>img/profile-slider/worker/banner-9.jpg" />
	    </div>
...
<!--begin small tile-->
                                ...
                                <!--begin terms tile -->
									<a class="tile bg-black" href='<?php echo $base."admin/badges";?>' data-toggle='modal'>
										<div class="tile-content icon">
											<?php 
											$newmessages = $this->users->newMessageCount($user['email_addr'], 'badge');
											if($newmessages>0) {?>
												<div class="badge bg-red pull-right"><?php echo $newmessages;?></div>
												<?php
											}?>
											<span class="icon"><img src="<?php echo $base;?>img/myprofile/badges.png"></span>
										</div>
                                ...
                                <div class="tile-group no-margin no-padding clearfix span1" >
									...
									<a class="tile  bg-black" href="<?php echo $base."admin/".$my_library_page;?>">
										<div class="tile-content icon">
											<?php 
											$newmessages = $this->users->newMessageCount( $user['email_addr'], 'assign', array('Badge') );
