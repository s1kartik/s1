...
<div class="homebg metro ">
    ...
    <div class="container-fluid">
        ...
        <em class="margin20">FATALITY BREAKDOWN&nbsp;&nbsp;<i class="icon "><img src="<?php echo $base;?>img/fatality/youtube.png" /></i></em>
		</div>
    </div>
    <!--END PAGE TITLE-->
    <div class="container-fluid fatality_metro">
            ...
            <div class="fatalityCon clearfix">
				...
				<div class="tile-group no-margin no-padding clearfix span4 " > 
                    ...
                    <a href="<?php echo $base;?>admin/hazard" class="tile bg-red">
						<div class="tile-content icon"><i class="icon "><img src="<?php echo $base;?>img/fatality/digital_hazards.png" /></i></div>
						<div class=" brand"><span class="label ">Digital HAZARDS</span></div>
					</a>
		...
		<div id="fatality_modal1" class="metro modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" style="background-color:none;width:462px;" >
			<a href="http://globalwasteservice.ca/" target="new"><img src="<?php echo $base;?>img/ad/fatality/ad1.jpg" /></a>
			<div class="modal-footer bg-gray"><button class="btn" data-dismiss="modal" onclick="$('#fatality_modal1').hide();">Close</button></div>
		</div>
<!-- ******************** end AD1 modal page ************************************* --> 
 <!-- *********** start AD2 MODAL page ******************************** -->
	<div id="fatality_modal2" class="metro modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" style="background-color:none;width:462px;" >
		<a href="http://globalwasteservice.ca/" target="new"><img src="<?php echo $base;?>img/ad/fatality/ad2.jpg" /></a>
		<div class="modal-footer bg-gray"><button class="btn" data-dismiss="modal" onclick="$('#fatality_modal2').hide();">Close</button></div>
	</div>
<!-- ******************** end AD2 modal page ************************************* --> 
		</div>
		<?php 
...
<script type="text/javascript">
	...
	$("#myModal .btn-close,.icon-cancel-2").click(function() {
		// Add User Quiz details //
			...
			$.ajax({
				url: js_base_path+'ajax/checkIfAllQuizAnswered', 
				type: 'post', 
				async: false, 
				data: {'quizSectionId':$videoId}, 
	...
	function checkQuizAnswer(videoId, quizId, correctAns, totalQuizAnswers)
	{
		var user_answer 		= $("input[name='answer"+quizId+"']:checked").val();
		// alert( "correctAns: "+correctAns + "user_answer: "+user_answer );
		// Add User Quiz details //
			$.post(js_base_path+'ajax/addQuizDetails', {'quizSectionId':videoId,'quizId':quizId,'correctAns':correctAns,'userAnswer':user_answer,'totalQuizAnswers':totalQuizAnswers, 'quizSection':'fatality_breakdown'}, function(data) {
				return true;
			});
