...
<div class="homebg metro profile-view">
    ...
    <div class="container">
        ...
        <em class="margin20">PROFILE SETTINGS&nbsp;&nbsp;
        	<a href="#info_profile_settings_worker_modal" data-toggle='modal'><span class="icon-info-2 s1_info fg-white"></span></a>
        </em> 
        </div>
    </div>
    <!-- Start INFO Modal --> 
    <?php // Modal: INFO//
	$this->load->view('info/profile_settings_worker_modal');?>	
    <!-- End INFO Modal -->
    <!--END PAGE TITLE-->
    <div class="container">
        <div class="main-content padding-metro-home popOuter clearfix"> 
							...
							<div id="union_group">
								...
								if( "9" == $this->sess_usertype ) {?>
									...
									<?php 
										...
										$where_arr = array('st_designation'=>"hsrep", 'in_union_id'=>$union_id,'in_worker_id'=>$this->sess_userid);
										...
										$where_arr = array('st_designation'=>"shop_steward", 'in_union_id'=>$union_id,'in_worker_id'=>$this->sess_userid);
										...
										<script type="text/javascript">
											$(document).ready(function() {
												$("#union<?php echo $cnt_myunion;?>").change(function() { 
													var where_arr = new Array(); 
													var union_id = $(this).val();
													where_arr.push({ 'union_id': union_id,'worker_id': '<?php echo $this->sess_userid;?>' });
													$.post(js_base_path+'admin/getDesignationData', {'tblName': 'tbl_union_designations', 'whereStr': where_arr}, 
														function(data){
															$unions_designations = $.parseJSON(data);
															$("#hsrep<?php echo $cnt_myunion;?>").html($unions_designations.hsrep);
															$("#shop_steward<?php echo $cnt_myunion;?>").html($unions_designations.shop_steward);
														}
													);
												});
											});
										...
										<div id="union_list<?php echo $cnt_myunion;?> myunion_list">
											...
											<div class="control-group">
												...
												<div class="controls" id="hsrep<?php echo $cnt_myunion;?>"><?php echo $hsrep;?></div>
											</div>
											<div class="control-group">
												<label class="control-label">Shop Steward</label>
												<div class="controls" id="shop_steward<?php echo $cnt_myunion;?>"><?php echo $shop_steward;?></div>
											</div>
											<div class="control-group">
