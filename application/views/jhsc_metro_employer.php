             ...
             <div class="tile-group no-margin no-padding clearfix " > 
                ...
                <a class="tile bg-black">
					...
					if( file_exists(FCPATH.$this->path_upload_profiles.$user['profile_image']) ) {?>
						...
						<img src="<?php echo $base;?>img/default.png">
					<?php }?>                  
                </a>
                <!--end tile-->
                <!--begin assign tile -->
                ...
                <a class="tile bg-black" href="<?php echo $base;?>admin/my_inspection_metro">
                    <div class="tile-content icon">
                ...
                <a class="tile bg-black" href="<?php echo $base;?>admin/mylibrary_procedures_metro">
                    <div class="tile-content icon">
                ...
                <a class="tile bg-black" href="<?php echo $base;?>admin/mylibrary_safetytalks_metro">
                    <div class="tile-content icon">
                ...
                <a href="<?php echo $base;?>admin/mylibrary_hazards_metro" class="tile bg-black">
                    <div class="tile-content icon">
                ...
                <a class="tile bg-black" href="<?php echo $base;?>admin/mylibrary_training_metro">
                    <div class="tile-content icon">
                ...
                <!--end NEW WORKER tile-->
                <!--begin DATA tile -->
                <a href="<?php echo $base;?>admin/dig_safety_board_metro_employer" class="tile bg-black">
                    <div class="tile-content icon">
