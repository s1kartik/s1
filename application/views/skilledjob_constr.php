	...
	<div class="homebg metro ">
		<!--BEGIN PAGE TITLE-->
			<div class="container-fluid">
				<div class="main-content padding-metro-header subheader-secondary clearfix fg-grayLighter"><em class="margin20">SKILLED JOB CONSTRUCTION</em></div>
        ...
        <div class="container-fluid skillgaps-cpnstr-buttons">
         <span class="" ><img src="<?php echo $base;?>img/skilled-job/certification_back.png" /> Compulsory (Mandatory) Certified Trade</span>
         <span class="" ><img src="<?php echo $base;?>img/skilled-job/redseal_back.png" /> Red Seal</span> 
        </div>
		<div class="container-fluid ">        
			<div class="main-content padding-metro-home skilledjob-data-container clearfix"> 
				<!--START CODE FOR METRO STYLE-->
					...
					<!-- BEGIN SECOND COLUMN FIRST ROW -->
						<div class="tile-group  no-padding clearfix max780" id="constr_tile"> 
							...
							if( $result > 0 ) {
								while ($cnt_limit <= $result) {
                                    ...
                                    <?php 
										$redseal = substr($constr[$cnt_limit]['certification'],0, 2);
										$certification = substr($constr[$cnt_limit]['trade_cert'],0, 10);
										//if ($redseal != "No" ){$redsealmsg = $constr[$cnt_limit]['certification'];};
										$redsealmsg = (($redseal != "No")?"<img src=".$base."img/skilled-job/redseal_back.png /> ".$constr[$cnt_limit]['certification']:" ");
										$certmsg = (($certification == "Compulsory")?"<img src=".$base."img/skilled-job/certification_back.png /> ".$constr[$cnt_limit]['trade_cert']:" ");
										$contents_on_hover[$cnt_limit] 	= '<p><b>'.$this->common->subString($constr[$cnt_limit]['descr'],100).'</b></p><h6>'.$certmsg.'</h6><h6>'.$redsealmsg.'</h6>'; ?>
										<a href="<?php echo $base;?>admin/constr_trade_metro?item=<?php echo $cnt_limit;?>" rel="#" class="tile half-library bg-black description" data-toggle="modal" data-content="<?php echo $contents_on_hover[$cnt_limit];?>" data-original-title="<?php echo "<h5 class='margin10'>".$constr[$cnt_limit]['trade']."</h5>"; ?>" data-placement="bottom" data-trigger="hover">
                                        <div class="half bg-black">
													<i class="icon on-left"><img src="<?php echo $base;?>img/skilled-job/construction_55x55.png"></i>
													<span class="fg-white" style="position:absolute;top:0px;"><small><?php echo $this->common->subString($constr[$cnt_limit]['trade'], 17);?></small></span>
										</div>
										<div class="brand ">
                                        <?php 
										//echo $certification;
										if ($certification == "Compulsory" ){?>
                                         	<div class="badge no-margin fg-white bg-darkCyan" style="right:40px;padding:3px;"><img src="<?php echo $base;?>img/skilled-job/certification.png" /></div>
                                            <?php  }
										
										if ($redseal != "No" ){?>
                                        	<div class="badge no-margin bg-red" style="padding:3px;" ><img src="<?php echo $base;?>img/skilled-job/redseal.png" /></div>
							...
							// Pagination //
								if( $result > $records_limit ) {
									...
									$this->common->getS1Pagination('skilledjob_constr?1', $total_pages, $current_page, $records_limit, 10);
									echo "</div>";
								}
							?>
							<!--  item -->
					...
					<!-------BEGIN THIRD COLUMN FIRST ROW OF TILES------>
						<div class="tile-group no-margin no-padding span4" >                    
