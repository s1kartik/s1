...
<p>Hello <?php echo ucfirst($userfirstname);?></p>
<p style="margin-top:20px">
Welcome to S1 Integration Systems and thank-you for submitting your registration.  
Please click on email confirmation <a href="<?php echo $url;?>"><?php echo $url;?></a> to complete your registration.  
Once logged in please complete “Get Started” for a site tutorial.</p>

<p>Thank-you for joining S1 Integration Systems.  Contact us at <a href="mailto:info@mys1s.ca">info@mys1s.ca</a> with questions or suggestions.</p>
