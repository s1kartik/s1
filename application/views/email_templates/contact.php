...
<h2 style="color:#ed1d24">One member sent a message from www.mys1s.ca website.</h2>
<p>Member First Name: <?php echo $fname;?></p>
<p>Member E-mail: <?php echo $meberemail;?></p>
<p>Name typed: <?php echo $name;?></p>
<p>Phone typed: <?php echo $phone;?></p>
<p>Email typed: <?php echo $email;?></p>
