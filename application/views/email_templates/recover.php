...
S1 Integration Systems has received a request to change the password for your account.  
To reset, click on forgot password <a href="<?php echo $url;?>"><?php echo $url;?></a>. </p>


<p>If you did not make this request, please ignore this email message and your password will remain the same.</p>
<p>Thank-you</p>
<p>The S1 Team</p>
     </div>
