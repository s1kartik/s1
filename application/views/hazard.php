      ...
      <div id="equip-landing" class="profile-menu-box">
         <div class="profile-menu-heading clearfix">
          ...
          <select id="hazard-industry-dropdown" class="bg-red fg-white" >
          	...
          	<!--option value="Office" onClick="window.location.href='<?php echo $base."admin/hazard_office";?>';">Office</option-->
          </select>
          </div>
          </span>
         </div>
			...
			<div class="main-content padding-metro-home clearfix"> 
						<!--START CODE FOR METRO STYLE-->
								...
								<!--begin Digital Hazards STATS tile -->
                                    <a class="tile bg-black" href='#hazards_status_modal' data-toggle='modal'>
                                ...
                                <!--begin Digital Hazards tile -->
                                    <a class="tile bg-black tile_hazards" href="<?php echo $base."admin/hazard_high_rise_front";?>">
                                        <div class="tile-content icon">
                                        	<span class="icon">
                                        		<img src="<?php echo $base;?>img/hazards/construction/high_rise/front/high_front.png">
                                            </span>
                                         </div>
                                        <div class="brand"><div class="label">High Rise<br /> Front Side</div></div>
                                    </a>
                                <!--end  Digital Hazards  tile-->
                                <!--begin Digital Hazards tile -->
                                    <a class="tile bg-black tile_hazards" href="<?php echo $base."admin/hazard_high_rise_back";?>">
                                        <div class="tile-content icon">
                                        	<span class="icon">
                                        		<img src="<?php echo $base;?>img/hazards/construction/high_rise/back/high_back.png">
                                            </span>
                                         </div>
                                        <div class="brand"><div class="label">High Rise<br />  Back Side</div></div>
                                    </a>
                                <!--end  Digital Hazards  tile-->
                                <!--begin Digital Hazards tile -->
...
<!-- *********** start HAZARDS Stats MODAL page ******************************** -->
	<div id="hazards_status_modal" class="metro modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" style="background-color:none;	margin-top:-2%; max-width:1000px;" >
    <div class="modal-body">
		<a href="#" >
        <img src="<?php echo $base;?>img/hazards/construction/hazards_stats.png" />
...
<script type="text/javascript">
	...
	$('#hazards_status_modal').css({ 'width':'100%',  'max-width':'800px' });
