...
<div class="homebg ">
    ...
    <div class="container-fluid">
        ...
        <em class="margin20"><h3>LOCAL 183 PUBLIC PAGE</h3></em>
        </div>
    </div>
    <!--END PAGE TITLE-->
...
<div class="union-container u-metro">
    ...
    <nav class="navigation-bar-content title nav-local183" >
		...
		<ul class="element-menu local183-menu" id="metro-left-menu">
			...
			<!--li class="element-divider"></li>
			<li class="element-menu" ><a href="#" data-target="#myCarousel" data-slide-to="4"><strong>PARTICIPANT PORTAL</strong></a></li-->
			<li class="element-divider"></li>
			...
			<li class="element-divider"></li>
			<li class="nav-local183"><a data-original-title="FACEBOOK" href="https://www.facebook.com/pages/Union-Local-183/175591665803669" title="" target="_new"><i class="icon-facebook"></i></a></li>
			<li class="element-divider"></li>
		</ul> 
    </nav>
	</nav>
    ...
    <div class="active item">
		<div class="carousel-content">
       		<div class="carousel-content-inner">
                ...
                <span><a href="http://www.liunalocal183.ca/AboutUs/Local183.aspx" class="btn btn-local183" target="new">Read More</a></span>
       		</div>
		</div>
		<img src="<?php echo $base;?>img/union/local183_0.jpg" />
    </div>
    <div class="item">
		<div class="carousel-content">
       		<div class="carousel-content-inner">
            <h3 style="color:#FFF">News & Meetings from LiUNA! Local 183</h3>
       			<!--<p style="color:#FFF"></p> -->
       			<span><a href="<?php echo $base;?>admin/union_news_metro?id=<?php echo $userid;?>" class="btn btn-local183">Read More</a></span>
       		</div>
		</div>
		<img src="<?php echo $base;?>img/union/local183_1.jpg" />
    </div>
    <div class="item">
		<div class="carousel-content">
       		<div class="carousel-content-inner">
				<h3 style="color:#FFF">LiUNA! LOCAL 183 Gives Back to the Community</h3>
       			<!--<p>Here at S1 we care about your Health and Safety</p>-->
       			<span><a href="<?php echo $base;?>admin/union_events_metro?id=<?php echo $userid;?>" class="btn btn-local183">Read More</a></span>
       		</div>
		</div>
		<img src="<?php echo $base;?>img/union/local183_2.jpg" />
    </div>
    <div class="item">
		<div class="carousel-content">
       		<div class="carousel-content-inner">
            <!--<h3 style="color:#FFF">LiUNA! LOCAL183 TRAINING CENTRE PAGE</h3> -->
       			<!--<p>Here at S1 we care about your Health and Safety</p> -->
       			<span><a href="<?php echo $base;?>admin/s1_public_page_union?id=181" class="btn btn-local183" style="right:50px;">Go!</a></span>
       		</div>
		</div>
	...
	<!--end slider-->     
     ...
     <!-- End MainSlider Row -->
        ...
        <div class="row-fluid">
		<div class="module">
			<h5 class="title-local183">SEARCH FOR REPS</h5>
			<div class="module-inner">
        		<div class="search">
				 <form method="post" id="filterfrm">
					<fieldset>
						 <div class="controls controls-row ">																	   
							<select name="cmb_sector" id="cmb_sector" class="span2 selectpicker" data-style="btn-local183">
							...
							<select name="cmb_job_title" id="cmb_job_title" class="span3 selectpicker" data-style="btn-local183">
							...
							<button class="span1 btn btn-local183"  id="btn-go" type="button" >Go!</button>
						 </div>
					</fieldset>	 
				 </form>								 
			</div>
		...
		<div class="row-fluid">
				...
				<div class="module">
					...
					<div class="module-inner">
						...
						<div class="content-margin">	
							...
							<a href="<?php echo $base;?>admin/union_events_metro?id=<?php echo $userid;?>" class="btn btn-local183">all events</a>
						</div>
					</div>
				</div>
			<!--------END UPCOMING EVENTS-------->	
			<!-- START NEWS -->
				<div class="module">
					...
					<div class="module-inner">
					<div class="row-fluid">
						<div class="span7"><h4 class="item-title">Marlen Silva of Sherwood Mortgage Offers Exclusive Deals to Local 183 Members!</h4></div>
						<div class="span5 u-time"><i class="icon-time "></i> 1/27/2015 5:04 PM</div>
					</div>			
					<div class="content-margin">	
						<p>I believe in discussions before decisions. This is what “Long term friends, serving long term custom...</p>
						<a href="<?php echo $base;?>admin/union_news_metro?id=<?php echo $userid;?>" class="btn btn-local183">more news</a>
					</div>
					</div>
				</div>
			<!-- END NEWS -->
