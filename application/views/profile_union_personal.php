...
<?php endif;?>
    ...
    <form class="form-horizontal adminfrm" method="post" action="<?php if(isset($rel)):?><?php echo $base;?>admin/union_profile?section=professional&id=<?php echo $_GET['id'];?><?php else:?><?php echo $base;?>admin/profile_setting?section=personal<?php endif;?>" enctype="multipart/form-data">
       
            <!-- Form Name -->
            <legend>Union Personal Information</legend>
            <!-- Text input-->
            <div class="control-group">
              <label class="control-label" for="email">Union Name</label>
              <div class="controls">
            ...
            <div class="control-group">
                ...
                <div class="controls">
					...
					if( isset($user['profile_image']) && $user['profile_image'] ) {?>
						<a title="Profile Image"><img src="<?php echo $base.$this->path_upload_profiles.$user['profile_image'];?>" class="w45 h40"></a>
						<?php 
					}?>
                </div>
            </div>
