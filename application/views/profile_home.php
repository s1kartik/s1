    ...
    <!--END PAGE TITLE-->
		<div class="container">
			<div class="main-content padding-metro-home clearfix">		
                            ...
                            <div class="clearfix profilehomeCon dashboard-content">
...
<div id ="myCarousel" class="carousel slide">
   ...
   <div class="carousel-content">
    ...
    <div class="item">
    	 <img src="<?php echo $base.$this->path_img_slider."banner-6.jpg";?>" />
    </div>
    <div class="item">
     <img src="<?php echo $base.$this->path_img_slider."banner-7.jpg";?>" />
    </div>
    <div class="item">
    	 <img src="<?php echo $base.$this->path_img_slider."banner-8.jpg";?>" />
    </div>
    <div class="item"> 
    	<img src="<?php echo $base.$this->path_img_slider."banner-9.jpg";?>" />
    </div>
