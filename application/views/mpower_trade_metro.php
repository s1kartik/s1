...
<!--***********************************************************-->
    ...
    <div class="container">
        ...
        <em class="margin20">SKILLED JOB MOTIVE POWER SECTOR</em>
        </div>
     </div>
	<!--END PAGE TITLE-->
		<div class="container">
			...
			<div class="tile-group no-margin no-padding clearfix" > 
                <div class="tile quadro marcio_profile_home triple-vertical bg-white panel">
                    ...
                    <i class="icon on-left"><img src="<?php echo $base;?>img/skilled-job/motive_power_28x28.png"></i>
                        <?php echo $mpower[$item]['trade'];?>
                        <span class="pull-right back-side-arrow">
						<a href='<?php echo $base;?>admin/skilledjob_mp' class="icon-arrow-left fg-white" title="Back"></a>
                        </span>
                    </div>
				<div class=" pre-scrollable"> 
    				...
    				<span href="#mypageModal" data-toggle="modal" >
                        ...
                        <p class="s1content_body_section"><?php echo $mpower[$item]['trade_cert'];?></p>
                        <p class="s1content_subtitle">Description:</p>
                        <p class="s1content_body_section"><?php echo $mpower[$item]['descr'];?></p>
						...
						<?php 
                            ...
                            while ($i <= $result):
                                ?>   
                                <li class="s1content_body_section"><?php echo $mpower[$item]['required'][$i];?></li>
                        <?php    
                            $i++;
                        endwhile;
                        ?>
						...
						<?php 
                            ...
                            while ($i <= $result):
                                ?>   
                                <li class="s1content_body_section"><?php echo $mpower[$item]['obtaining'][$i];?></li>
                        <?php    
                            $i++;
                        endwhile;
                        ?>
						...
						<?php 
                            ...
                            while ($i <= $result):
                                ?>   
                                <li class="s1content_body_section"><?php echo $mpower[$item]['related'][$i];?></li>
                        <?php    
                            $i++;
                        endwhile;
                        ?>
						...
						<?php 
                            ...
                            while ($i <= $result):
                                ?>   
                                <li class="s1content_body_section"><?php echo $mpower[$item]['potential'][$i];?></li>
                        <?php    
                            $i++;
                        endwhile;
                        ?>
                        ...
                        <p class="s1content_body_section"><?php echo $mpower[$item]['sal'];?></p>
                        </span>
		...
		<div id="mypageModal" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
			<div class="modal-header bg-black">
				<h3 id="myModalLabel"><i class="icon on-left"><img src="<?php echo $base;?>img/skilled-job/motive_power_28x28.png"></i>
                        <?php echo $mpower[$item]['trade'];?>
