...
<script type="text/javascript">
    ...
    <div class="container-fluid">
        ...
        <em class="margin20">HOME - CONSULTANT&nbsp;&nbsp;
        <a href="#info_profile_home_consultant_modal" data-toggle='modal'><span class="icon-info-2 s1_info fg-white"></span></a>
            </em>
        </div>
    </div>
    <!-- Start INFO Modal --> 
    <?php // Modal: INFO//
					$this->load->view('info/profile_home_consultant_modal');
...
<div id="myCarousel" class="carousel slide">
    ...
    <div class="carousel-inner">
	    <div class="active item">
	       	<img src="<?php echo $base;?>img/profile-slider/consultant/banner-0.jpg" />
	    </div>
	
	    <div class="item">
	       		<img src="<?php echo $base;?>img/profile-slider/consultant/banner-1.jpg" />
	    </div>
	    
		<div class="item">
	    	<img src="<?php echo $base;?>img/profile-slider/consultant/banner-2.jpg" />
	    </div>
	    
	    <div class="item">
	    	<img src="<?php echo $base;?>img/profile-slider/consultant/banner-3.jpg" />
	    </div>
	    <div class="item">
	    	<img src="<?php echo $base;?>img/profile-slider/consultant/banner-4.jpg" />
	    </div>
	    <div class="item">
	    	<img src="<?php echo $base;?>img/profile-slider/consultant/banner-5.jpg" />
	    </div>
	    <div class="item">
	    	<img src="<?php echo $base;?>img/profile-slider/consultant/banner-6.jpg" />
	    </div>
	    <div class="item">
	    	<img src="<?php echo $base;?>img/profile-slider/consultant/banner-7.jpg" />
	    </div>
	    <div class="item">
	    	<img src="<?php echo $base;?>img/profile-slider/consultant/banner-8.jpg" />
	    </div>
	    <div class="item">
	    	<img src="<?php echo $base;?>img/profile-slider/consultant/banner-9.jpg" />
	    </div>
...
<!--begin MY picture tile -->
			...
			<!--end  my workers tile-->
                                <!--begin MY DATA tile -->
                                    ...
                                    <a class="tile bg-black" href="<?php echo $base;?>admin/my_clients">
                                        <div class="tile-content icon"><span class="icon"><img src="<?php echo $base;?>img/myprofile/social_network.png"></span></div>
                                        <div class="brand"><div class="label">CLIENTS</div></div>
										<?php 
										...
										if($open_client_library>0) {?>
											<div class="badge bg-red pull-right"><?php echo $open_client_library;?></div>
											<?php 
										}?>
                                    </a>
								...
								?>
                                    ...
                                    <a href="" class="tile bg-black <?php echo $dpclass;?>">
                                        <div class="tile-content icon">
